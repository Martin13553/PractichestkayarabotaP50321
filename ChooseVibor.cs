...
{
    public static class ChooseVibor
    {
    ...
    public static class GetEmployee
    {
        public static void Start()
        {
            string[] adminMenuItems = { "1- Employee id",
            "2 - ID users",
            "3 - Имя",
            "4 -Фамилия",
            "5 - Отчество",
    ...
    public static class ShowEmployee
    {
        ...
        {
            Console.WriteLine($"{"Personal ID",15}|{"First Name",15}|{"Last Name",25}|{"Patronymic",25}|");
            List<string> res = new List<string>();
            ...
            ChooseVibor.Start(personals.ElementAt(choose));
        }
    }
